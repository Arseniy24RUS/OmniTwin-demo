...
export const DEFAULT_CONTEXT:DemoContextV1={datasetId:'omnitwin-public-fictional-chelyabinsk-v1',analyticsSource:'observed',observedYear:2024,territoryId:'RU-CHE-SET',scenario:'baseline',year:2026,cohort:null,presentationMinutes:1100,weather:'clear',playing:true,speed:1,camera:{longitude:61.4026,latitude:55.1684,zoom:16.7,pitch:58,bearing:-24}};
